...
require $_SERVER['DOCUMENT_ROOT'] . '/includes/log_activity.php';
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (isset($_SERVER['CONTENT_TYPE']) && strpos($_SERVER['CONTENT_TYPE'], 'application/json') !== false) {
        ...
        // Replace FILTER_SANITIZE_STRING (deprecated) with FILTER_SANITIZE_SPECIAL_CHARS
   ...
   switch ($type) {
    case 'generate_otp':
        ...
        // Ensure the function matches the expected parameters
    ...
    case 'resend_otp':
        ...
        // Ensure function call matches parameters
        $response = generateOTP($email, $phoneNumber, $conn);
        echo json_encode($response);
        break;
