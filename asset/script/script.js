...
const swiper = new Swiper('.swiper', {
    ...
    pagination: {
        ...
        renderBullet: function (index, className) {
            const images = [
                '../asset/img/testimonial/ogabashir.jpg',
                '../asset/img/testimonial/ogaismail.jpg',
                '../asset/img/testimonial/ogamubarak.jpg',
                '../asset/img/testimonial/dawaki.jpg',
                '../asset/img/testimonial/ogamuhammad.jpg',
                '../asset/img/testimonial/muhammadtukur.jpg',
            ];
...
// the call action in about
    const callAction = () =>{
        ...
        let learnMoreSection = document.querySelector('#learn-more');
