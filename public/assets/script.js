...
const swiper = new Swiper('.swiper', {
    ...
    pagination: {
        ...
        renderBullet: function (index, className) {
            const images = [
                './assets/img/testimonial/ogabashir.jpg',
                './assets/img/testimonial/ogaismail.jpg',
                './assets/img/testimonial/ogamubarak.jpg',
                './assets/img/testimonial/dawaki.jpg',
                './assets/img/testimonial/ogamuhammad.jpg',
                './assets/img/testimonial/muhammadtukur.jpg',
            ];
