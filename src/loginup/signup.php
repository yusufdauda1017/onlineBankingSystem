...
<header id="header">
    <div class="container d-flex align-items-center justify-content-between">
        ...
        <div class="text-end">
            ...
            <a href="../login-form/index.php" class="btn btn-success d-inline-block d-lg-none">Log In</a>

            <!-- Text + Button for Larger Screens (md, lg, xl, xxl) -->
            <p class="d-none d-lg-block mb-0">
                Already have an account?
                <a href="../login-form/index.php" class="btn btn-success px-4 mx-3">Log In</a>
            </p>
        </div>
    </div>
</header>
