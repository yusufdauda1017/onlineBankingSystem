<?php
require_once __DIR__ . '/../../db/db_connect.php'; // Database connection
require_once __DIR__ . '/../../includes/log_activity.php'; // Logging functionality
require_once __DIR__ . '/../../includes/check_remember.php'; // Remember me feature
