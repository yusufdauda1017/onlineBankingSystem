...
<div>
  ...
  <div class="search-box input-container mb-3">
    <input type="text" id="accountInput" class="floating-input w-100"  autocomplete="off">
     ...
     <div class="spinner-border text-primary mt-2 mb-0 d-none" id="loadingSpinner" role="status">
  ...
  <div class="mb-3">
        ...
        <div class="spinner-border text-primary mt-0 mb-0 d-none" id="loadingSpinner" role="status">
              <span class="visually-hidden">Loading...</span>
            </div>
...
<div id="accountName" class = "mb-3"></div>
  ...
  <div class="row justify-content-center mt-5">
    ...
    <div class="col-auto">
      <button type="button" class="btn btn-success" style="width: 180px" id="btn-account">
        Continue
      </button>
    </div>
  </div>
...
<div class="header">
  ...
  <!-- Loading Spinner for Transaction Processing -->
  <div class="text-center d-none mt-3" id="loadingSpinner2">
...
<div class="header">
  <img src="../img/logo/logo-1.png" alt="Brand Logo" />
        ...
        <div  class=" shadow p-3">
          ...
          <button class="btn btn-outline-danger w-100 mt-2" onclick="goBack()">
            Cancel
          </button>
        </div>
        ...
        <div class="modal-dialog modal-dialog-centered">
          <div class="modal-content">
            <div class="modal-header bg-dark text-white">
              <h5 class="modal-title fw-bold" id="pinModalLabel">Enter Transaction PIN</h5>
              <button type="button" class="btn-close text-white" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
              <div class="mb-3">
                <label for="transactionPin" class="fw-bold mb-3 text-success">Enter Your 4-Digit PIN</label>
                <input type="password" id="transactionPin" class="form-control text-center fw-bold py-3 transactionPin" placeholder="" maxlength="4" />
                <small class="text-danger d-none" id="pinError">Incorrect PIN. Try again.</small>
              </div>
            </div>
            <div class="modal-footer">
              <button type="button" class="btn btn-outline-secondary" data-bs-dismiss="modal">Cancel</button>
              <button type="button" class="btn btn-success fw-bold" id="confirmTransaction">Confirm Transfer</button>
            </div>
          </div>
        </div>
      </div>
